...
const HomePage = () => {
  ...
  return (
    <div className='w-full mx-auto p-4 bg-[#0ea5e9] fixed top-0 left-0 right-0 z-10'>
        ...
        <h1 className='xss:hidden md:flex text-xl'>RESET INŽINJERING</h1>
        ...
        <AiOutlineClose className='absolute top-4 right-4 cursor-pointer' 
                    ...
                    <h1 className='text-xl  p-4'>Reset Inzinjering</h1>


                    <ul className='flex flex-col items-start p-4 text-black text-lg mt-[50px] text-xl'>
